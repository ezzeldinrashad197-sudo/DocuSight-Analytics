...
async function runE2EIntegrationTest() {
  ...
  console.log(`${colors.bright}${colors.cyan}  DOCUSIGHT E2E INTEGRATION PIPELINE VERIFICATION SUITE  ${colors.reset}`);
  console.log(`${colors.bright}${colors.cyan}================================================================================${colors.reset}\n`);
  ...
  const markdownContent = `# DocuSight E2E Integration Pipeline Verification Report

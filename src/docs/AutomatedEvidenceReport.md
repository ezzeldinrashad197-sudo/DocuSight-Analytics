...
*Generated on 2026-08-14T09:25:14.023Z via DocuSight Custom AST Compliance Engine*
...
| :--- | :--- | :--- |
| **Audit Timestamp** | `2026-08-14T09:25:14.023Z` | Universal Coordinated Time (UTC) of verification run |
...
| **Total Pipeline Wall Time**| `**2.031 seconds**` | Combined execution duration of AST scanning and verification pipeline |

### ⏱️ VERIFICATION RUNTIME METRIC SPLIT

| Verification Stage | Processed Task | Measured Duration | Percentage (%) | Status |
| :--- | :--- | :--- | :--- | :--- |
| **AST Parsing & Codebase Scan** | Recursive scan of all source directories, reading file ASTs | `1.999 seconds` | `98.4%` | COMPLETED ✅ |
| **Call Graph Tracing** | AST path exploration, extracting import/export and call edges | `0.001 seconds` | `0.0%` | COMPLETED ✅ |
| **Rule & Complexity Evaluation** | Execution of circular dependency checks, layer compliance, dead code analysis, Halstead, cyclomatic metrics | `0.025 seconds` | `1.2%` | COMPLETED ✅ |
| **Artifact & Report Generation** | Compilation and serialization of JSON, DOT, Mermaid, and MD files | `0.006 seconds` | `0.3%` | COMPLETED ✅ |
| **Total Pipeline Wall Time** | Integrated end-to-end execution of verification sequence | `**2.031 seconds**` | `100.0%` | **SUCCESS** ✅ |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **calculations.ts (Core calculations SSOT)** | `src/utils/calculations.ts` | `f28538393be6f51a228f086835de0a8195313c8904927ee9c93aca52761e302c` | `38.46 KB` | `2026-08-14T08:40:39.153Z` | `Included` |
| **run-tests.ts (Mathematical regression runner)** | `scripts/run-tests.ts` | `e5bc7804e9ac0d310a713d588c70d369ecadcdf33f862a82aeba0fdd43b40430` | `34.17 KB` | `2026-08-14T08:40:39.152Z` | `Included` |
| **generate-evidence-report.ts (This evidence generator)** | `scripts/generate-evidence-report.ts` | `eaf7ff2bbc7068ff1c7d445ca653f75aa7a527e5d6514515a790242d379884fd` | `54.80 KB` | `2026-08-14T08:40:39.115Z` | `Included` |
| **architecture-audit.ts (SSOT structure checker)** | `scripts/architecture-audit.ts` | `3d176590422424fd98c82f2139c11dba2b370e3a03ee5cc1ea1cd5c9735cc630` | `9.30 KB` | `2026-08-14T08:40:39.187Z` | `Included` |
| **run-integration-tests.ts (E2E simulation harness)** | `scripts/run-integration-tests.ts` | `24f6d61dde8d936b54153a2dba499b2e532c8ed8885e7d90ff1cf9c0c0376d12` | `15.38 KB` | `2026-08-14T08:40:39.119Z` | `Included` |
| **package-lock.json (Resolved lockfile)** | `package-lock.json` | `ce89c1e19d802e642ada0bec4aecf48d0daf83f0a61d0451a285b98e599478d8` | `403.85 KB` | `2026-08-14T08:40:39.138Z` | `Excluded (Config/Lockfile)` |
| **package.json (Project manifest)** | `package.json` | `b0f7b5410ee03354e5c674af98cab9925cfbe7f1dc1ee8e71285901faea89095` | `2.04 KB` | `2026-08-14T08:40:39.107Z` | `Excluded (Config/Manifest)` |
| **tsconfig.json (TS compiler options)** | `tsconfig.json` | `e93e15c3794e43a117964ea191ae985cbedea70c41d3d82b2e20aa8d07374fe4` | `0.50 KB` | `2026-08-14T08:40:39.134Z` | `Excluded (Config/Compiler)` |
